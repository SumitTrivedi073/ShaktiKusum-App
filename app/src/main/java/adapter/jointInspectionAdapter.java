...
public class jointInspectionAdapter extends RecyclerView.Adapter<jointInspectionAdapter.ViewHolder> implements Filterable {
    ...
    public jointInspectionAdapter(Context context, List<JointInspectionModel.InspectionDatum> responseList,TextView noDataFound) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, @SuppressLint("RecyclerView") int position) {
                ...
                holder.item_card.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Intent intent = new Intent(context, JointInspectionImageActivity.class);
