...
public class DocSubHO extends AppCompatActivity implements BarCodeSelectionAdapter.BarCodeSelectionListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if( CustomUtility.getSharedPreferences(DocSubHO.this, Constant.quantity).isEmpty()){
            ShowQuantityPopup();
        }
    ...
    private void Init() {
        ...
        getSupportActionBar().setTitle(getResources().getString(R.string.docSubHO));
                ...
                for (int i = 0; i < barcodenameList.size(); i++) {
                    ...
                    if (barcodenameList.get(i).isEmpty()) {
                        ...
                        if (set.contains(barcodenameList.get(i).toUpperCase())) {
                            isSubmit = false;
                            CustomUtility.ShowToast(barcodenameList.get(i) + getResources().getString(R.string.moduleMultipleTime), DocSubHO.this);
                            break;
                        } else {
    ...
    private class saveData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            progressDialog = new ProgressDialog(DocSubHO.this);
        ...
        protected String doInBackground(String... params) {
            ...
            Log.e("url====>", WebURL.docSubHO + param1_invc);
            System.out.println("param1_invc_vihu==>>" + param1_invc);
            try {
                StrictMode.ThreadPolicy policy = new StrictMode.ThreadPolicy.Builder().build();
                StrictMode.setThreadPolicy(policy);
                obj2 = CustomHttpClient.executeHttpPost1(WebURL.docSubHO, param1_invc);
                Log.e("OUTPUT1", "&&&&" + obj2);
                ...
                if (!obj2.equalsIgnoreCase("")) {
                    ...
                    CustomUtility.showToast(DocSubHO.this, getResources().getString(R.string.somethingWentWrong));
                    progressDialog.dismiss();
                }
            } catch (Exception e) {
                e.printStackTrace();
    ...
    private void showingMessage(String message) {
        runOnUiThread(new Runnable() {
            public void run() {
                ...
                CustomUtility.showToast(DocSubHO.this, message);
    ...
    private void setAdapter() {
        ...
        barCodeSelectionAdapter = new BarCodeSelectionAdapter(DocSubHO.this, barcodenameList);
    ...
    private void ShowQuantityPopup() {
        LayoutInflater inflater = (LayoutInflater) DocSubHO.this
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View layout = inflater.inflate(R.layout.inhousequantiypopup,
                null);
        final AlertDialog.Builder builder = new AlertDialog.Builder(DocSubHO.this, R.style.MyDialogTheme);
        ...
        submit.setOnClickListener(v -> {
            if(totalQuantity.getText().toString().isEmpty()){
                CustomUtility.showToast(DocSubHO.this,getResources().getString(R.string.enter_quantity));
            } else{
                Log.e("totalQuantity==>",  totalQuantity.getText().toString());
                serialNoLength = totalQuantity.getText().toString();
                CustomUtility.setSharedPreference(DocSubHO.this, serialNoLength, Constant.quantity);
