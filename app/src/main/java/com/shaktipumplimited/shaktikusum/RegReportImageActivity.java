...
public class RegReportImageActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    boolean photo1_flag = false,
            ...
            photo11_flag = false,
            photo12_flag = false;
    private String mHomePath, PathHolder, Filename,type="REG/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if(extras == null) {
                ...
                cust_nm= extras.getString("cust_nm");
                enq_docno= extras.getString("reg_id");
            }
        } else {
            cust_nm= (String) savedInstanceState.getSerializable("cust_nm");
            enq_docno= (String) savedInstanceState.getSerializable("reg_id");
        }

        File root = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES),GALLERY_DIRECTORY_NAME);

        File dir = new File(root.getAbsolutePath() + "/SKAPP/REG/"); //it is my root directory

        File billno = new File(root.getAbsolutePath() + "/SKAPP/REG/" + enq_docno); // it is my sub folder directory .. it can vary..
    ...
    private void setData() {
        ...
        File file = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_1.jpg");
        if (file.exists()) {
            photo1_text = file.getAbsolutePath();
        }

        File file1 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_2.jpg");
        if (file1.exists()) {
            photo2_text = file1.getAbsolutePath();
        }

        File file2 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_3.jpg");
        if (file2.exists()) {
            photo3_text = file2.getAbsolutePath();
        }

        File file3 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_4.jpg");
        if (file3.exists()) {
            photo4_text = file3.getAbsolutePath();
        }

        File file4 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_5.jpg");
        if (file4.exists()) {
            photo5_text = file4.getAbsolutePath();
        }

        File file5 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_6.jpg");
        if (file5.exists()) {
            photo6_text = file5.getAbsolutePath();
        }

        File file6 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_7.jpg");
        if (file6.exists()) {
            photo7_text = file6.getAbsolutePath();
        }

        File file7 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME+ "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_8.jpg");
        if (file7.exists()) {
            photo8_text = file7.getAbsolutePath();
        }

        File file8 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_9.jpg");
        if (file8.exists()) {
            photo9_text = file8.getAbsolutePath();
        }

        File file9 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_10.jpg");
        if (file9.exists()) {
            photo10_text = file9.getAbsolutePath();
        }

        File file10 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_11.jpg");
        if (file10.exists()) {
            photo11_text = file10.getAbsolutePath();
        }

        File file11 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_12.jpg");
        if (file11.exists()) {
                    ...
                    if (data != null) {
                        ...
                        try {
                            ...
                            if (selectedImageUri != null) {
                                ...
                                if (photo1_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_1.jpg";
                                ...
                                if (photo2_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_2.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file1 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_2.jpg");
                                    if (file1.exists()) {
                                        photo2_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo3_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_3.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file2 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_3.jpg");
                                    if (file2.exists()) {
                                        photo3_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo4_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_4.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file3 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_4.jpg");
                                    if (file3.exists()) {
                                        photo4_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo5_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_5.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file4 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_5.jpg");
                                    if (file4.exists()) {
                                        photo5_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo6_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_6.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file5 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_6.jpg");
                                    if (file5.exists()) {
                                        photo6_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo7_flag == true) {
                                    String destFile =getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_7.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file6 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_7.jpg");
                                    if (file6.exists()) {
                                        photo7_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo8_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_8.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file7 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_8.jpg");
                                    if (file7.exists()) {
                                        photo8_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo9_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_9.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file8 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_9.jpg");
                                    if (file8.exists()) {
                                        photo9_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo10_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_10.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file9 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_10.jpg");
                                    if (file9.exists()) {
                                        photo10_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo11_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_11.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file10 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_11.jpg");
                                    if (file10.exists()) {
                                        photo11_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
                                ...
                                if (photo12_flag == true) {
                                    String destFile = getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno + "/IMG_PHOTO_12.jpg";
                                    copyFile(selectedImagePath, destFile);
                                    File file11 = new File(getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES).getAbsolutePath()+"/"+GALLERY_DIRECTORY_NAME  + "/SKAPP/REG/" + enq_docno, "/IMG_PHOTO_12.jpg");
                                    if (file11.exists()) {
                                        photo12_text = Base64.encodeToString(byteArray, Base64.DEFAULT);
            ...
            if (!TextUtils.isEmpty(pht2)) {
                if (!TextUtils.isEmpty(pht3)) {
                    if (!TextUtils.isEmpty(pht4)) {
                        ...
                        CustomUtility.setSharedPreference(mContext, "SYNC" + enq_docno, "1");
                    } else {
