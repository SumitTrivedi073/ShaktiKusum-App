...
import com.shaktipumplimited.shaktikusum.utility.dialog2;
...
public class OffSubDocActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(OffSubDocActivity.this, mString, Toast.LENGTH_LONG).show();
...
/*    public static void deleteFiles(String path) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yourDialog = new dialog2(activity);
        yourDialog.show();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(remark_txt)) {
                    new OffSubData().execute(remark_txt);
                } else {
    ...
    private class OffSubData extends AsyncTask<String, String, String> {
