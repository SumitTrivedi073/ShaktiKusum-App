...
public class InstallationInitial extends AppCompatActivity {
    ...
    private void serverIbaseUpdateFunctions() {
        ...
        new Thread() {
            public void run() {
                try {
                    String obj = com.shaktipumplimited.shaktikusum.webservice.CustomHttpClient.executeHttpPost1(NewSolarVFD.UPDATE_IBASE_VK_PAGE, param);
    ...
    private class SyncInstallationData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                obj2 = com.shaktipumplimited.shaktikusum.webservice.CustomHttpClient.executeHttpPost1(WebURL.INSTALLATION_DATA, param1_invc);
