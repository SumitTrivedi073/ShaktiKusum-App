...
import com.shaktipumplimited.shaktikusum.utility.dialog1;
...
public class DeptDocSubActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            Toast.makeText(DeptDocSubActivity.this, mString, Toast.LENGTH_LONG).show();

        }
    };
    private ProgressDialog progressDialog;
    private DeptDocSubActivity activity;
...
/*    public static void deleteFiles(String path) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        yourDialog = new dialog1(activity);
        yourDialog.show();
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(remark_txt)) {
                    new DeptSubData().execute(remark_txt);
                } else {
    ...
    private class DeptSubData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            param1_invc.add(new BasicNameValuePair("doc_department", String.valueOf(ja_invc_data)));
