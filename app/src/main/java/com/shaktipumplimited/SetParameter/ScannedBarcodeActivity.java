    ...
    private void initViews() {
      ...
      /*  btnAction.setOnClickListener(new View.OnClickListener() {
        ...
        rlvSubmitBarcodeDataID.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String spspsp = edtBarcodeValueID.getText().toString().trim();
                if(!spspsp.equalsIgnoreCase("") && !spspsp.equalsIgnoreCase("Null"))
                {
                    Intent intent = new Intent(getApplicationContext(),DeviceSettingActivity.class);
intent.putExtra("MCode", spspsp);
                    ...
                    edtBarcodeValueID.post(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (barcodes.valueAt(0).email != null) {
                                ...
                                WebURL.barCodeResult= intentData;
                                //Constant.barCodeResult= "B43644A5687M000";
                                isEmail = true;
                               // finish();
